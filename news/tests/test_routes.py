"""
Модуль тестирования маршрутов (URL) приложения новостей.

Содержит тесты для проверки:
- Доступности публичных страниц для всех пользователей
- Прав доступа к страницам редактирования и удаления комментариев
- Редиректов анонимных пользователей на страницу авторизации
- Корректности работы системы прав доступа для различных пользователей
"""
...
class TestRoutes(TestCase):
    """
    Тестирование доступности маршрутов приложения новостей.
    ...
    def setUpTestData(cls):
        ...
        Создает:
        - Тестовую новость
        - Автора комментария и обычного пользователя
        - Тестовый комментарий для проверки доступа
        """
    ...
    def test_pages_availability(self):
        ...
        страницы входа и регистрации возвращают статус 200 OK
    ...
    def test_availability_for_comment_edit_and_delete(self):
        """
        Тестирует права доступа к стр. редактирования и удаления комментариев.
